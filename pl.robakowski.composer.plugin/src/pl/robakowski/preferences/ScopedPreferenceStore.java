 ...
 * @since 3.1
 */
public class ScopedPreferenceStore extends EventManager implements IPreferenceStore,
IPersistentPreferenceStore
{
    ...
    /**
     * The searchContext is the array of contexts that will be used by the get methods for searching for
     * values.
     */
    ...
    /**
     * The listener on the IEclipsePreferences. This is used to forward updates to the property change
     * listeners on the preference store.
     */
    IEclipsePreferences.IPreferenceChangeListener preferencesListener;

    /**
     * The default context is the context where getDefault and setDefault methods will search. This context is
     ...
     * <strong>NOTE:</strong> Any instance of ScopedPreferenceStore should call
     *
     * @param context
    ...
    private INodeChangeListener getNodeChangeListener()
    {
        return new IEclipsePreferences.INodeChangeListener()
        {
             ...
             *
             * @see
             * org.eclipse.core.runtime.preferences.IEclipsePreferences.INodeChangeListener#added(org.eclipse
             * .core.runtime.preferences.IEclipsePreferences.NodeChangeEvent)
             */
            @Override
             ...
             *
             * @see
             * org.eclipse.core.runtime.preferences.IEclipsePreferences.INodeChangeListener#removed(org.eclipse
             * .core.runtime.preferences.IEclipsePreferences.NodeChangeEvent)
             */
            @Override
    ...
    /**
     * Does its best at determining the default value for the given key. Checks the given object's type and
     * then looks in the list of defaults to see if a value exists. If not or if there is a problem converting
     * the value, the default default value for that type is returned.
     *
     * @param key
     *            the key to search
     * @param obj
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.jface.preference.IPreferenceStore#addPropertyChangeListener(org.eclipse.jface.util.
    ...
    /**
     * Return the preference path to search preferences on. This is the list of preference nodes based on the
     * scope contexts for this store. If there are no search contexts set, then return this store's context.
     * <p>
        ...
        if( searchContexts == null )
        {
            if( includeDefault )
            {
                return new IEclipsePreferences[]
                    { getStorePreferences(), getDefaultPreferences() };
            }
            return new IEclipsePreferences[]
                { getStorePreferences() };
        }
    ...
    /**
     * Set the search contexts to scopes. When searching for a value the seach will be done in the order of
     * scope contexts and will not search the storeContext unless it is in this list.
     * <p>
     * If the given list is <code>null</code>, then clear this store's search contexts. This means that only
     * this store's scope context and default scope will be used during preference value searching.
     * </p>
     * <p>
     * The defaultContext will be added to the end of this list automatically and <em>MUST NOT</em> be
    ...
    /**
     * Return the string value for the specified key. Look in the nodes which are specified by this object's
     * list of search scopes. If the value does not exist then return <code>null</code>.
     *
     * @param key
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.jface.preference.IPreferenceStore#removePropertyChangeListener(org.eclipse.jface.util.
     * IPropertyChangeListener)
     */
    @Override
    ...
    public void setValue( String name, boolean value )
    {
        ...
        try
        {
            ...
            dirty = true;
            firePropertyChangeEvent( name, oldValue ? Boolean.TRUE : Boolean.FALSE, value ? Boolean.TRUE
                : Boolean.FALSE );
        }
        finally
        {
